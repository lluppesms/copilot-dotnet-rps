...
public class Game
{
    ...
    public static Choice ValidateAndConvertInput(string input)
    {
    ...
    public static string GetWinner(Choice userChoice, Choice computerChoice)
    {
    ...
    public static void UpdateScores(string result, Score score)
    {
        if (result == YouWin)
        {
            score.UserScore++;
    ...
    public static void DisplayChoice(Choice choice)
    {
        switch (choice)
        {
            case Choice.Rock:
